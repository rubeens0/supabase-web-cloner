  ...
  return (
    ...
    >
      ...
      <motion.button
        ...
        whileTap={{ scale: 0.92 }}
        className="absolute top-1/2 -translate-y-1/2 -translate-x-1/2 z-20 h-11 w-11 rounded-full bg-white text-black flex items-center justify-center shadow-2xl cursor-grab active:cursor-grabbing focus:outline-none focus:ring-2 focus:ring-white/70"
        style={{ left: `${pos}%` }}
      >
