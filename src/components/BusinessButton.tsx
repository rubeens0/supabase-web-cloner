  ...
  return (
    ...
    >
      <button
        ...
        className="flex items-center gap-2 bg-gradient-mono text-black rounded-full pl-4 pr-5 py-3 text-[13px] font-medium hover:brightness-110 transition-all shadow-[0_8px_32px_-4px_rgba(0,0,0,0.6)] border border-white/20 whitespace-nowrap"
      >
