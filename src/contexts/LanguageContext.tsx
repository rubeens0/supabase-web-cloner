...
const translations = {
  es: {
    ...
    'home.about.p2':
      'En el ámbito deportivo, me dedico al karting, una de las disciplinas más exigentes que existen. Actualmente compito en el Campeonato de España de Karting, enfrentando cada curva con pasión y determinación.',
    'home.about.p3':
      'Paralelamente, también he desarrollado proyectos en el mundo del emprendimiento. Mi historia apenas comienza, pero estoy decidido a dejar huella.',
    ...
    'business.about.p1':
      'Netpro Agency es un estudio profesional de diseño y marketing digital. Nacimos enfocados al motorsport —pilotos, equipos y proyectos de karting y automovilismo—, pero hoy también trabajamos con empresas de distintos sectores que necesitan una imagen sólida y resultados reales en el entorno digital.',
    'business.about.p2':
