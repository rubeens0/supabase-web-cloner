...
Many thanks to all the people involved.`,
    ...
    },
    {
      ...
      content: language === 'es'
        ? `Hoy estrenamos una nueva etapa en rubenmunoz.com. La web ha sido rediseñada por completo, con una identidad visual más editorial, tipografías más cuidadas y una experiencia pensada para acompañar el salto deportivo y profesional de esta temporada 2026.\n\nMás que un lavado de cara, este rediseño marca un cambio de mentalidad: pasar de una simple web de piloto a una plataforma que reúne el proyecto deportivo, el dossier para patrocinadores, los proyectos paralelos y un espacio privado para el equipo más cercano.\n\nNueva sección 2026 — Calendario CEK interactivo\n\nUno de los grandes protagonistas del rediseño es la nueva sección dedicada a la temporada 2026 del Campeonato de España de Karting. En ella se incluye un mapa 3D interactivo de España donde se pueden ver, numerados cronológicamente, los cuatro circuitos del calendario: Campillos, MotorLand Aragón, Kartódromo Lucas Guerrero (Chiva) y Aspar Circuit (Guadassuar). Cada cita aparece con su fecha, ubicación y enlace directo a la información de la carrera.\n\nAcceso al paddock\n\nUna de las novedades más importantes es la creación del Acceso al Paddock, un área privada pensada para patrocinadores, colaboradores y miembros del círculo cercano. Desde ahí se podrá acceder al dossier completo, materiales de marca, calendario interno, contenido exclusivo de carreras y comunicaciones directas. Es un paso para profesionalizar al máximo la relación con quienes apuestan por el proyecto.\n\nNuevos proyectos\n\nEl rediseño también deja espacio a los proyectos paralelos que han ido tomando forma durante el último año: Netpro Agency (estudio de diseño y marketing enfocado al motorsport), el grupo de jóvenes emprendedores Netspy ES y nuevas colaboraciones con marcas como Albroksa y Caja Rural de Extremadura. Todo conectado bajo una misma identidad, dejando claro que no se trata solo de competir, sino de construir una marca personal sólida y a largo plazo.\n\nDetalles técnicos y experiencia\n\n- Nueva paleta y tipografía editorial.\n- Animaciones suaves, transiciones cuidadas y modo oscuro como base.\n- Mapa 3D del calendario CEK con WebGL.\n- Sección de blog renovada, con artículo destacado y archivo cronológico.\n- Optimización SEO, metadatos por artículo y carga acelerada en móvil.\n\nEsto es solo el principio. La idea es que la web evolucione cada temporada, sumando datos en directo, contenido audiovisual y nuevas formas de conectar con el público y los patrocinadores. Gracias a quienes ya forman parte de este proyecto y bienvenidos a esta nueva etapa.`
